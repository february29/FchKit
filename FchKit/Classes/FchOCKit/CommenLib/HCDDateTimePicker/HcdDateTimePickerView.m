...
- (void)setTimeBroadcastView
{
    ...
    timeBroadcastView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, WIDTH, 190.0)];
    ...
    if (self.datePickerMode == DatePickerDateMode) {
        ...
        [self setMinuteScrollView];
         ...
         [self setYearScrollView];
    }else if (self.datePickerMode == DatePickerYearMonthDayHourMinute) {
        [self setYearScrollView];
        [self setMonthScrollView];
        [self setDayScrollView];
        [self setHourScrollView];
...
//    [timeBroadcastView setFrame:CGRectMake(0, HEIGHT-100, WIDTH, kDatePickerHeight)];
    [timeBroadcastView setFrame:CGRectMake(0, 0, WIDTH, kDatePickerHeight)];
}
//设置年月日时分的滚动视图
- (void)setYearScrollView
{
    if (self.datePickerMode == DatePickerDateTimeMode) {
        ...
        yearScrollView = [[MXSCycleScrollView alloc] initWithFrame:CGRectMake(0, 30, WIDTH*1, 190.0)];
    }else if (self.datePickerMode == DatePickerYearMonthDayHourMinute) {
        yearScrollView = [[MXSCycleScrollView alloc] initWithFrame:CGRectMake(0, 30, WIDTH*0.28, 190.0)];
    }
...
- (void)setMonthScrollView
{
    if (self.datePickerMode == DatePickerDateTimeMode) {
        ...
        monthScrollView = [[MXSCycleScrollView alloc] initWithFrame:CGRectMake(WIDTH*0.28, 30, WIDTH*0.18, 190.0)];
    }
...
- (void)setDayScrollView
{
    if (self.datePickerMode == DatePickerDateTimeMode) {
        ...
        dayScrollView = [[MXSCycleScrollView alloc] initWithFrame:CGRectMake(WIDTH*0.46, 30, WIDTH*0.18, 190.0)];
    }
...
- (void)setHourScrollView
{
    if (self.datePickerMode == DatePickerDateTimeMode) {
        ...
        hourScrollView = [[MXSCycleScrollView alloc] initWithFrame:CGRectMake(WIDTH*0.64, 30, WIDTH*0.18, 190.0)];
    }
...
- (void)setMinuteScrollView
{
    if (self.datePickerMode == DatePickerDateTimeMode) {
        ...
        minuteScrollView = [[MXSCycleScrollView alloc] initWithFrame:CGRectMake(WIDTH*0.82, 30, WIDTH*0.18, 190.0)];
    }
...
-(NSString *)selectedModleStr{
    NSString *string;
    
    
    if (self.datePickerMode == DatePickerDateMode) {
        string = [NSString stringWithFormat:@"%ld-%02ld-%02ld",(long)self.curYear,(long)self.curMonth,(long)self.curDay];
    }
    else if (self.datePickerMode == DatePickerTimeMode) {
        string = [NSString stringWithFormat:@"%02ld:%02ld:%02ld",(long)self.curHour,(long)self.curMin,(long)self.curSecond];
    }
    else if (self.datePickerMode == DatePickerDateTimeMode) {
        string = [NSString stringWithFormat:@"%ld-%02ld-%02ld %02ld:%02ld:%02ld",(long)self.curYear,(long)self.curMonth,(long)self.curDay,(long)self.curHour,(long)self.curMin,(long)self.curSecond];
    }
    else if (self.datePickerMode == DatePickerYearMonthMode) {
        string = [NSString stringWithFormat:@"%ld-%02ld",(long)self.curYear,(long)self.curMonth];
    }
    else if (self.datePickerMode == DatePickerMonthDayMode) {
        string = [NSString stringWithFormat:@"%02ld-%02ld",(long)self.curMonth,(long)self.curDay];
    }
    else if (self.datePickerMode == DatePickerHourMinuteMode) {
        string = [NSString stringWithFormat:@"%02ld:%02ld",(long)self.curHour,(long)self.curMin];
    }
    else if (self.datePickerMode == DatePickerYearMode) {
        string = [NSString stringWithFormat:@"%ld",(long)self.curYear];
    }
    else if (self.datePickerMode == DatePickerYearMonthDayHourMinute) {
        string = [NSString stringWithFormat:@"%ld-%02ld-%02ld %02ld:%02ld:00",(long)self.curYear,(long)self.curMonth,(long)self.curDay,(long)self.curHour,(long)self.curMin];
    }
...
-(void)selectedButtons:(UIButton *)btns{
    ...
    if (btns.tag == kOKBtnTag) {
        weak.clickedOkBtn([self selectedModleStr]);
    } else {
        weak.clickedCancleBtn([self selectedModleStr]);
    }
...
//        } else {
//            weak.clickedCancleBtn(dateTimeStr);
//        }
//    }];
